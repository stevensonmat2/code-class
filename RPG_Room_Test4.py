...
# pygame.init()
#
# pygame.mixer.music.load("game_music_1.wav")
...
weapons = [ Weapons('sword', 0, 5, 50, 100, 1),
...
# when leveling up, multiply previous level enemy attributes by .5
        ...
        while fighting == True:
            if 'enemy' in rooms[currentRoom]:
                ...
                if enemyHealthFin <= 0:
                    ...
                    enemyAttkChance = randint(0, 2)
                    enemyAttk = (roomEnemy['attack'] - enemyAttkChance) -playerDef
                    # print(enemyAttk)
                    print('---------------')
                    print(roomEnemy['name'] + ' fights back for ' + str(enemyAttk))
                    # print(roomEnemy['attack'])
                    print('---------------')
                    playerHealthCurr = playerHealthNow - ((roomEnemy['attack'] - enemyAttkChance) - playerDef)
